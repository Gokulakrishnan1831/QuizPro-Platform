    ...
    <div style={{ 
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: '#a5b4fc', marginTop: '0.5rem' }}>Continue your learning journey</p>
        </div>
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center', color: '#6b7280' }}>
          Don't have an account? <Link href="/get-started" style={{ color: '#6366f1', textDecoration: 'none', fontWeight: '600' }}>Sign Up</Link>
        </div>
      </motion.div>
    </div>
  );
